 ...
 * @author ASUS
 */
public class Affiche_porfilejobeur_plomberieController implements Initializable {
     @FXML
    ...
    public void AfficheVOTE(){
        ...
        int nblike;
        Jobeur A=new Jobeur();
        A=Interface_choisir_jobeur_plomberieController.jp;
   ...
   public void ajouterfa(){
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            System.out.println(Interface_choisir_jobeur_plomberieController.jp);
    ...
    private void Retour(ActionEvent event) {
         Parent root = null;
        try {
             root = FXMLLoader.load(getClass().getResource("/fxml/Interface_choisir_jobeur_menage_plomberie.fxml"));
                } catch (IOException ex) {
