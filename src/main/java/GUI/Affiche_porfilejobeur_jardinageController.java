 ...
 * @author ASUS
 */
public class Affiche_porfilejobeur_jardinageController implements Initializable {
     @FXML
    ...
    public void AfficheVOTE(){
        ...
        int nblike;
        Jobeur A=new Jobeur();
        A=Interface_choisir_jobeur_jardinageController.jj;
   ...
   public void ajouterfa(){
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            System.out.println(Interface_choisir_jobeur_jardinageController.jj);
        ...
        AfficheVOTE();
         ...
         if (event.getButton().equals(MouseButton.SECONDARY) && event.getClickCount() == 1){
             ...
             try {
                 ...
                 Logger.getLogger(Affiche_porfilejobeur_jardinageController.class.getName()).log(Level.SEVERE, null, ex);
             }
    ...
    private void Retour(ActionEvent event) {
         Parent root = null;
        try {
             root = FXMLLoader.load(getClass().getResource("/fxml/Interface_choisir_jobeur_jardinage.fxml"));
                } catch (IOException ex) {
